...
export default class LocalBookRepository implements BookRepository {
    ...
    search(term: string): Book {
        ...
        return new Book(uuidv4(), "x", "x", "x", 1, false);
    }
    ...
    async fillStorage() {
        ...
        for (const book of this.localBooks) {
            await storage.setData("local", book);
        }
    }
